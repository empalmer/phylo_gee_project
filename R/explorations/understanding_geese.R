# Simple example to work through code 
data(seizure)
...
# This function is mostly a wrapper function to format 
# arguments to the actual 
...
geese.fit <- function(x, y, id,
  ...
  # clusnew is the ids of the new cluster
  ...
  maxclsz <- max(clusz)
  # define waves if they are not specified (next2 lines)
