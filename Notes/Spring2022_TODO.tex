...
\begin{todolist}
  ...
  \item Try changing the minus sign on larger dataset.
  \item[\done] Set up automatic save outputs along with description
  \item Try with a medium sized dataset, like prevalence of .2?
  \item Save test datasets to files for easy loading
  \item Only include last beta output?
\end{todolist}
\end{document}
